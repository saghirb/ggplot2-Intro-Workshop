...
```{r shapes, echo=F, out.width="80%", fig.width=6}
## A look at all 25 symbols
dfshapes <- as.data.table(list(value = 0:25))
dfshapes[, x:=(value %% 5) + 1][
  , z:=floor((value)/5) + 1][
  , y:=max(z)-z][
  , z:=NULL]
...
### - Lots more than this 3 hour workshop could show
...
### https://github.com/saghirb

### https://ilustat.com/resources
]
.pull-right[
