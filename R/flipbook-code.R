#
#  *_* Start: Code copied from https://github.com/EvaMaeRey/ggplot_flipbook *_*
# The following code has been copy and pasted from `ggplot_flipbook_xaringan.Rmd`
# which is part of https://github.com/EvaMaeRey/ggplot_flipbook
#
...
#  *_* END: Code copied from https://github.com/EvaMaeRey/ggplot_flipbook *_*
